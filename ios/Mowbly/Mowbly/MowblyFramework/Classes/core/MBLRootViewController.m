...
- (void)viewDidLoad {
    ...
    if (screenRect.size.height == 568) {
        ...
        NSString *path = [[NSBundle mainBundle] pathForResource:@"LaunchImage@2x" ofType:@"png"];
        if (path) {
            [splashScreenView setImage:[UIImage imageWithContentsOfFile:@"LaunchImage@2x"]];
        } else {
        ...
        if (path) {
            ...
            [splashScreenView setImage:[UIImage imageNamed:@"LaunchImage"]];
        } else {
        ...
        NSString *path = [[NSBundle mainBundle] pathForResource:@"LaunchImage-700-Portrait~ipad" ofType:@"png"];
        if (path) {
            [splashScreenView setImage:[UIImage imageNamed:@"LaunchImage-700-Portrait~ipad"]];
